...
public class NameParser {
	...
	static {
		...
		// former affiliation
		regex.add(new RegexRule("(([^\\(]+) \\((until (\\d{0,2}\\s?(?:Jan(?:uary)?|Feb(?:ruary)?|Mar(?:ch)?|Apr(?:il)?|May|Jun(?:e)?|Jul(?:y)?|Aug(?:ust)?|Sep(?:tember)?|Sept|Oct(?:ober)?|Nov(?:ember)?|Dec(?:ember)?)\\s?\\d{0,2},? \\d{4}),? while [with|at]+ ([^\\(]+))\\))", new int[]{2, 0, 0, 5, 4, 0, 0, 0, 0, 0}));
		regex.add(new RegexRule("(([^\\(]+) \\(until (\\d{0,2}\\s?(?:Jan(?:uary)?|Feb(?:ruary)?|Mar(?:ch)?|Apr(?:il)?|May|Jun(?:e)?|Jul(?:y)?|Aug(?:ust)?|Sep(?:tember)?|Sept|Oct(?:ober)?|Nov(?:ember)?|Dec(?:ember)?)\\s?\\d{0,2},? \\d{4})\\)\\s?, ([^<]+) <([^>]+)>)", new int[]{2, 0, 0, 4, 3, 0, 5, 0, 0, 0}));
		regex.add(new RegexRule("(([^\\(]+) \\((while at (.+?(?=, currently)), currently ([^\\(]+)\\)))", new int[]{2, 5, 0, 4, 0, 0, 0, 0, 0, 0}));
		regex.add(new RegexRule("(([^\\(]+ \\([^\\)]+\\)) \\(until (\\d{0,2}\\s?(?:Jan(?:uary)?|Feb(?:ruary)?|Mar(?:ch)?|Apr(?:il)?|May|Jun(?:e)?|Jul(?:y)?|Aug(?:ust)?|Sep(?:tember)?|Sept|Oct(?:ober)?|Nov(?:ember)?|Dec(?:ember)?)\\s?\\d{0,2},? \\d{4}),? while a[t|n] ([^\\)]+)\\))", new int[]{2, 0, 0, 4, 3, 0, 0, 0, 0, 0}));
		...
		regex.add(new RegexRule("(([^<]+) <(.+)> - [^\\s]+ edition)", new int[]{2, 0, 0, 0, 0, 0, 0, 0, 3, 0}));
		regex.add(new RegexRule("(([^,]+) <([^>]+)> \\(.+\\))", new int[]{2, 0, 0, 0, 0, 0, 3, 0, 0, 0}));
		regex.add(new RegexRule("(([^,]+), (.+) <(.+@.+)> \\((Until (\\d{0,2}\\s?(?:Jan(?:uary)?|Feb(?:ruary)?|Mar(?:ch)?|Apr(?:il)?|May|Jun(?:e)?|Jul(?:y)?|Aug(?:ust)?|Sep(?:tember)?|Sept|Oct(?:ober)?|Nov(?:ember)?|Dec(?:ember)?)\\s?\\d{0,2},? \\d{4})\\)))", new int[]{2, 0, 0, 3, 6, 0, 4, 0, 0, 0}));
		regex.add(new RegexRule("(([^,]+), ([^\\(]+) \\((Until (\\d{0,2}\\s?(?:Jan(?:uary)?|Feb(?:ruary)?|Mar(?:ch)?|Apr(?:il)?|May|Jun(?:e)?|Jul(?:y)?|Aug(?:ust)?|Sep(?:tember)?|Sept|Oct(?:ober)?|Nov(?:ember)?|Dec(?:ember)?)\\s?\\d{0,2},? \\d{4})\\)))", new int[]{2, 0, 0, 3, 5, 0, 0, 0, 0, 0}));
		regex.add(new RegexRule("(([^,]+), ([^,]+), ([^@]+@.+))", new int[]{2, 0, 0, 3, 0, 0, 4, 0, 0, 0}));
		regex.add(new RegexRule("(([^\\(]+) \\((.+)\\), <([^@]+@.+)>)", new int[]{2, 0, 0, 3, 0, 0, 4, 0, 0, 0}));
		regex.add(new RegexRule("(([^,]+), ([^<]+) <([^@]+@[^>]+)> \\((for )?modularization and DTD\\))", new int[]{2, 0, 0, 3, 0, 0, 4, 0, 0, 0}));
		regex.add(new RegexRule("(([^,]+), ([^@]+@.+), (.+ \\(through (\\d{0,2}\\s?(?:Jan(?:uary)?|Feb(?:ruary)?|Mar(?:ch)?|Apr(?:il)?|May|Jun(?:e)?|Jul(?:y)?|Aug(?:ust)?|Sep(?:tember)?|Sept|Oct(?:ober)?|Nov(?:ember)?|Dec(?:ember)?)\\s?\\d{0,2},? \\d{4})\\)) \\/ (.+))", new int[]{2, 0, 0, 6, 0, 0, 3, 0, 0, 4}));
		...
		regex.add(new RegexRule("(([^,]+), ([^\\(]+) \\(and before at ([^\\)]+)\\))", new int[]{2, 0, 0, 3, 0, 0, 0, 0, 0, 4}));
